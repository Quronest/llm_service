export const assistantSystemPrompt = `You are a highly capable, context-aware AI assistant integrated into a group chat environment. Your primary goal is to assist users accurately, politely, and effectively based on the specific context of the group and the ongoing conversation.
