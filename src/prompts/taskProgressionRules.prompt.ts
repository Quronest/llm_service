...
GROUP A, Phase 1 (Very early / confused):
...
export const groupAphaseTwoRules = `### Curriculum & Progression Rules

When generating the 7-day plan, you MUST strictly adapt the tasks based on the user's CURRENT_GROUP, CURRENT_PHASE, and CURRENT_DAY. 
(Note: If CURRENT_DAY is 1, you are generating Days 1-7. If it is 8, you are generating Days 8-14. If it is 15, you are generating Days 15-21).

GROUP A, Phase 2 (Some awareness, no execution):
...
export const groupAphaseThreeRules = `### Curriculum & Progression Rules

When generating the 7-day plan, you MUST strictly adapt the tasks based on the user's CURRENT_GROUP, CURRENT_PHASE, and CURRENT_DAY. 
(Note: If CURRENT_DAY is 1, you are generating Days 1-7. If it is 8, you are generating Days 8-14. If it is 15, you are generating Days 15-21).

GROUP A, Phase 3 (Aligned but weak execution):
...
export const groupBphaseOneRules = `### Curriculum & Progression Rules

When generating the 7-day plan, you MUST strictly adapt the tasks based on the user's CURRENT_GROUP, CURRENT_PHASE, and CURRENT_DAY. 
(Note: If CURRENT_DAY is 1, you are generating Days 1-7. If it is 8, you are generating Days 8-14. If it is 15, you are generating Days 15-21).

GROUP B, Phase 1 (Beginner builder):
...
export const groupBphaseTwoRules = `### Curriculum & Progression Rules

When generating the 7-day plan, you MUST strictly adapt the tasks based on the user's CURRENT_GROUP, CURRENT_PHASE, and CURRENT_DAY. 
(Note: If CURRENT_DAY is 1, you are generating Days 1-7. If it is 8, you are generating Days 8-14. If it is 15, you are generating Days 15-21).

GROUP B, Phase 2 (Independent project builder):
...
export const groupBphaseThreeRules = `### Curriculum & Progression Rules

When generating the 7-day plan, you MUST strictly adapt the tasks based on the user's CURRENT_GROUP, CURRENT_PHASE, and CURRENT_DAY. 
(Note: If CURRENT_DAY is 1, you are generating Days 1-7. If it is 8, you are generating Days 8-14. If it is 15, you are generating Days 15-21).

GROUP B, Phase 3 (Advanced but untested professionally):
...
export const groupCphaseOneRules = `### Curriculum & Progression Rules

When generating the 7-day plan, you MUST strictly adapt the tasks based on the user's CURRENT_GROUP, CURRENT_PHASE, and CURRENT_DAY. 
(Note: If CURRENT_DAY is 1, you are generating Days 1-7. If it is 8, you are generating Days 8-14. If it is 15, you are generating Days 15-21).

GROUP C, Phase 1 (Project-experienced):
...
export const groupCphaseTwoRules = `### Curriculum & Progression Rules

When generating the 7-day plan, you MUST strictly adapt the tasks based on the user's CURRENT_GROUP, CURRENT_PHASE, and CURRENT_DAY. 
(Note: If CURRENT_DAY is 1, you are generating Days 1-7. If it is 8, you are generating Days 8-14. If it is 15, you are generating Days 15-21).

GROUP C, Phase 2 (Industry exposure):
...
export const groupCphaseThreeRules = `### Curriculum & Progression Rules

When generating the 7-day plan, you MUST strictly adapt the tasks based on the user's CURRENT_GROUP, CURRENT_PHASE, and CURRENT_DAY. 
(Note: If CURRENT_DAY is 1, you are generating Days 1-7. If it is 8, you are generating Days 8-14. If it is 15, you are generating Days 15-21).

GROUP C, Phase 3 (Professionally experienced):
...
import { type Group, type Phase } from "../types";
